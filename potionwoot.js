...
function startWooting() {
        ...
        css.innerHTML = "#autowooter-button { left: 213px; } .autowooter-icon-on { position: absolute; width: 30px; height: 30px; background: url("+ baseUrl + "bAwCrGk.png); } .autowooter-icon-off { position: absolute; width: 30px; height: 30px; background: url("+ baseUrl + "sM6rFtv.png); }";
...
function admin(contents) {
        var msg = '<div class="mention is-you"><i class="icon icon-chat-admin"></i><span class="from admin ">� ¹–Û£ÛœÄÙ„ - É´á´‡á´É´ - TFL </span><span class="text">&nbsp;' + contents + '</span></div>';
